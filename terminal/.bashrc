...
if [ -f ~/Scripts/git-sh-prompt ]; then
...
alias eclipse='$DEV_HOME/eclipse/eclipse'
...
export JAVA_HOME=~/workspace/jdk1.6.0_45
export MAVEN_OPTS="-XX:PermSize=65M -XX:MaxPermSize=512M -Xms500M -Xmx2000M -Xdebug -Xrunjdwp:transport=dt_socket,address=8000,server=y,suspend=n"
export MAVEN_HOME=~/workspace/apache-maven-3.0.5
